...
class OmniConnectorModelRunnerMixin:
    ...
    def init_omni_connectors(
        ...
        self._sender_info: dict[str, dict[str, Any]] = {}
    ...
    def _connector_supports_raw_for_edge(self, *, for_recv: bool) -> bool:
        ...
        connector = self._recv_connector if for_recv else self._send_connector
    ...
    def _should_use_qwen3_packet_path(
        ...
        *,
        ...
        relevant_connector = self._recv_connector if for_recv else self._send_connector
